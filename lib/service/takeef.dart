...
class Takeef extends StatefulWidget {
  ...
  @override
  State<Takeef> createState() => _TakeefState();
}

class _TakeefState extends State<Takeef> {
  @override
  Widget build(BuildContext context) {
    final Stream<QuerySnapshot> _prodcutsStream = FirebaseFirestore.instance.collection('products')
        ...
        .where('subcateg',isEqualTo: 'تكييفات وتبريد').snapshots();
    return Scaffold(
