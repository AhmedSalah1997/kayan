...
class Gam3yat extends StatefulWidget {
  ...
  @override
  State<Gam3yat> createState() => _Gam3yatState();
}

class _Gam3yatState extends State<Gam3yat> {
  @override
  Widget build(BuildContext context) {
    final Stream<QuerySnapshot> _prodcutsStream = FirebaseFirestore.instance.collection('products')
        ...
        .where('subcateg',isEqualTo: 'جمعيات خيرية').snapshots();
    return Scaffold(
      backgroundColor: Colors.grey.shade300,
      appBar: AppBar(
        elevation: 0,
        centerTitle: true,
        title: AppBarTitle(title: 'الجمعيات الخيرية',),
