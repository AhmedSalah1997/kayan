...
class Tarfeh extends StatefulWidget {
  ...
  @override
  State<Tarfeh> createState() => _TarfehState();
}

class _TarfehState extends State<Tarfeh> {
  @override
  Widget build(BuildContext context) {
    final Stream<QuerySnapshot> _prodcutsStream = FirebaseFirestore.instance.collection('products')
        ...
        .where('subcateg',isEqualTo: 'نادي رياضي').snapshots();
    return Scaffold(
