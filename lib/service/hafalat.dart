...
class Hafalat extends StatefulWidget {
  ...
  @override
  State<Hafalat> createState() => _HafalatState();
}

class _HafalatState extends State<Hafalat> {
  @override
  Widget build(BuildContext context) {
    final Stream<QuerySnapshot> _prodcutsStream = FirebaseFirestore.instance.collection('products')
        ...
        .where('subcateg',isEqualTo: 'قاعات وتنظيم حفلات').snapshots();
    return Scaffold(
