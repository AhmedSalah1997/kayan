...
class SalonRegaly extends StatefulWidget {
  ...
  @override
  State<SalonRegaly> createState() => _SalonRegalyState();
}

class _SalonRegalyState extends State<SalonRegaly> {
  @override
  Widget build(BuildContext context) {
    final Stream<QuerySnapshot> _prodcutsStream = FirebaseFirestore.instance.collection('products')
        ...
        .where('subcateg',isEqualTo: 'صالون رجالى').snapshots();
    return Scaffold(
      backgroundColor: Colors.grey.shade300,
      appBar: AppBar(
        elevation: 0,
        centerTitle: true,
        title: AppBarTitle(title: 'صالون رجالى',),
