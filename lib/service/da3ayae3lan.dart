...
class Da3aya extends StatefulWidget {
  ...
  @override
  State<Da3aya> createState() => _Da3ayaState();
}

class _Da3ayaState extends State<Da3aya> {
  @override
  Widget build(BuildContext context) {
    final Stream<QuerySnapshot> _prodcutsStream = FirebaseFirestore.instance.collection('products')
        ...
        .where('subcateg',isEqualTo: 'دعاية وإعلان').snapshots();
    return Scaffold(
      backgroundColor: Colors.grey.shade300,
      appBar: AppBar(
        elevation: 0,
        centerTitle: true,
        title: AppBarTitle(title: 'دعايا وإعلان',),
