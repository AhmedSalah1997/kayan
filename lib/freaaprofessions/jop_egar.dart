...
//
// class JopEgar extends StatelessWidget {
//   const JopEgar({Key? key}) : super(key: key);
//
//   @override
...
//                       mainAxisSpacing: 0,
//                       children:
//                       List.generate(shopsrent.length -1, (index) {
//                         return SubCategModel2(
//                           mainCategName: 'shopsrent',
//                           assetImages: 'images/clinics/beauty$index.jpg',
//                           assetName: shopsrent[index +1],
//                           subCategLabel: shopsrent[index +1],
//                         );
//                       }),
//                     ),
//                   ),
