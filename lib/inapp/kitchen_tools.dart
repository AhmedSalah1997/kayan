...
class KtchenTools extends StatefulWidget {
  @override
  _KtchenToolsState createState() => _KtchenToolsState();
}

class _KtchenToolsState extends State<KtchenTools> {

  final controller = PageController(viewportFraction: 0.8, keepPage: true);

  late final Stream<QuerySnapshot> _prodcutsStream = FirebaseFirestore.instance
      .collection('ktchentools')
      .snapshots();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: AppBarTitle(title: 'مستلزمات المطبخ',),
      ),
      body: Container(
