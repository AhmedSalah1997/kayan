...
class HomeSupplies extends StatefulWidget {
  @override
  _HomeSuppliesState createState() => _HomeSuppliesState();
}

class _HomeSuppliesState extends State<HomeSupplies> {

  final controller = PageController(viewportFraction: 0.8, keepPage: true);

  late final Stream<QuerySnapshot> _prodcutsStream = FirebaseFirestore.instance
      .collection('homesupplies')
      .snapshots();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: AppBarTitle(title: 'مستلزمات المنزل',),
      ),
      body: Container(
