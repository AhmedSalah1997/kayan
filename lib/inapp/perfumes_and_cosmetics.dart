...
class PerfumesandCosmetics extends StatefulWidget {
  @override
  _PerfumesandCosmeticsState createState() => _PerfumesandCosmeticsState();
}

class _PerfumesandCosmeticsState extends State<PerfumesandCosmetics> {

  final controller = PageController(viewportFraction: 0.8, keepPage: true);

  late final Stream<QuerySnapshot> _prodcutsStream = FirebaseFirestore.instance
      .collection('perfumesandcosmetics')
      .snapshots();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: AppBarTitle(title: 'عطور ومستحضرات تجميل',),
      ),
      body: Container(
