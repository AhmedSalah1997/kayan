...
class ClothesandShoes extends StatefulWidget {
  @override
  _ClothesandShoesState createState() => _ClothesandShoesState();
}

class _ClothesandShoesState extends State<ClothesandShoes> {

  final controller = PageController(viewportFraction: 0.8, keepPage: true);

  late final Stream<QuerySnapshot> _prodcutsStream = FirebaseFirestore.instance
      .collection('clothesandshoes')
      .snapshots();
