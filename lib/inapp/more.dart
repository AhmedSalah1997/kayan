...
import 'package:kyan/inapp/detalis.dart';
import 'package:staggered_grid_view_flutter/widgets/staggered_grid_view.dart';
import 'package:staggered_grid_view_flutter/widgets/staggered_tile.dart';
import '../minor/appbarwidget.dart';


class MorePay extends StatefulWidget {
  @override
  _MorePayState createState() => _MorePayState();
}

class _MorePayState extends State<MorePay> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor:Colors.grey.shade100,
        title: AppBarTitle(title: 'المزيد من المنتجات',),
      ),
      body: Container(
