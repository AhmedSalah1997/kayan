...
class EnputEgar extends StatefulWidget {
  @override
  _EnputEgarState createState() => _EnputEgarState();
}

class _EnputEgarState extends State<EnputEgar> {

  final controller = PageController(viewportFraction: 0.8, keepPage: true);

  late final Stream<QuerySnapshot> _prodcutsStream = FirebaseFirestore.instance
      .collection('Shopforrent')
      .snapshots();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: AppBarTitle(title: 'محلات للإيجار',),
      ),
      body: Container(
