...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final Uri facebook =
      Uri.parse('https://www.facebook.com/profile.php?id=100070243890807');
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                          height: 40, width: double.infinity, child: News()),
