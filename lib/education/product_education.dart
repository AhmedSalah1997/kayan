...
class ProductEducationSecreen extends StatefulWidget {
  ...
  @override
  State<ProductEducationSecreen> createState() =>
      _ProductEducationSecreenState();
}
...
class _ProductEducationSecreenState extends State<ProductEducationSecreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final Uri url =
        Uri(scheme: 'tel', path: '0${widget.educatin['number1'].toString()}');
