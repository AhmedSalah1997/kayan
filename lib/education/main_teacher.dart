  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: AppBarTitle( title: 'المراحل التعليمية',),
        backgroundColor: Colors.grey.shade200,
        elevation: 0,
      ),
              ...
              child: Column(
                children: [
                  Padding(padding: EdgeInsets.only(left: 15, bottom: 28 , right:  15),
                    child: Text('المراحل التعليمية  تمي الامديد', style: TextStyle(fontSize: 25),),
                  ),
                  Row(
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(textCateory1, overflow: TextOverflow.ellipsis, maxLines: 1,)
            ],
          ),
        ),
      ],
