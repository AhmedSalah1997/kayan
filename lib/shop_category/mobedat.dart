...
class Mobedat extends StatefulWidget {
  ...
  @override
  State<Mobedat> createState() => _MobedatState();
}

class _MobedatState extends State<Mobedat> {
  @override
  Widget build(BuildContext context) {
    final Stream<QuerySnapshot> _prodcutsStream = FirebaseFirestore.instance.collection('products')
        ...
        .where('subcateg',isEqualTo: 'مبيدات زراعية').snapshots();
    return Scaffold(
      backgroundColor: Colors.grey.shade300,
      appBar: AppBar(
        elevation: 0,
        centerTitle: true,
        title: AppBarTitle(title: 'مبيدات حشرية',),
