...
class Mata3m extends StatefulWidget {
  ...
  @override
  State<Mata3m> createState() => _Mata3mState();
}

class _Mata3mState extends State<Mata3m> {
  @override
  Widget build(BuildContext context) {
    ...
    final Stream<QuerySnapshot> _prodcutsStream = FirebaseFirestore.instance.collection('products')
        ...
        .where('subcateg',isEqualTo: 'مطاعم وكافيهات').snapshots();
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        elevation: 0,
        centerTitle: true,
        title: AppBarTitle(title: 'المطاعم والكافيهات',),
