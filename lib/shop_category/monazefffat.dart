...
class Monazefat extends StatefulWidget {
  ...
  @override
  State<Monazefat> createState() => _MonazefatState();
}

class _MonazefatState extends State<Monazefat> {
  @override
  Widget build(BuildContext context) {
    final Stream<QuerySnapshot> _prodcutsStream = FirebaseFirestore.instance.collection('products')
        ...
        .where('subcateg',isEqualTo: 'منظفات وبلاستيكات').snapshots();
    return Scaffold(
      backgroundColor: Colors.grey.shade300,
      appBar: AppBar(
        elevation: 0,
        centerTitle: true,
        title: AppBarTitle(title: 'منظفات وبلاستيك',),
