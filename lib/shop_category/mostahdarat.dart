...
class Mostahdarat extends StatefulWidget {
  ...
  @override
  State<Mostahdarat> createState() => _MostahdaratState();
}

class _MostahdaratState extends State<Mostahdarat> {
  @override
  Widget build(BuildContext context) {
    final Stream<QuerySnapshot> _prodcutsStream = FirebaseFirestore.instance.collection('products')
        ...
        .where('subcateg',isEqualTo: 'مستحضرات تجميل').snapshots();
    return Scaffold(
      backgroundColor: Colors.grey.shade300,
      appBar: AppBar(
        elevation: 0,
        centerTitle: true,
        title: AppBarTitle(title: 'مستضرات التجميل',),
