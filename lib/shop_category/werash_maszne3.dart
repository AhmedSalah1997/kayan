...
class WerashMasan3 extends StatefulWidget {
  ...
  @override
  State<WerashMasan3> createState() => _WerashMasan3State();
}

class _WerashMasan3State extends State<WerashMasan3> {
  @override
  Widget build(BuildContext context) {
    final Stream<QuerySnapshot> _prodcutsStream = FirebaseFirestore.instance.collection('products')
        ...
        .where('subcateg',isEqualTo: 'ورش ومصانع').snapshots();
    return Scaffold(
      backgroundColor: Colors.grey.shade300,
      appBar: AppBar(
        elevation: 0,
        centerTitle: true,
        title: AppBarTitle(title: 'الورش والمصانع',),
