...
class Maktabat extends StatefulWidget {
  ...
  @override
  State<Maktabat> createState() => _MaktabatState();
}

class _MaktabatState extends State<Maktabat> {
  @override
  Widget build(BuildContext context) {
    final Stream<QuerySnapshot> _prodcutsStream = FirebaseFirestore.instance.collection('products')
        ...
        .where('subcateg',isEqualTo: 'مكتبات وهدايا').snapshots();
    return Scaffold(
      backgroundColor: Colors.grey.shade300,
      appBar: AppBar(
        elevation: 0,
        centerTitle: true,
        title: AppBarTitle(title: 'المكتبات والهدايا',),
