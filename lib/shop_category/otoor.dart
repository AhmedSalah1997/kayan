...
class Otoor extends StatefulWidget {
  ...
  @override
  State<Otoor> createState() => _OtoorState();
}

class _OtoorState extends State<Otoor> {
  @override
  Widget build(BuildContext context) {
    final Stream<QuerySnapshot> _prodcutsStream = FirebaseFirestore.instance.collection('products')
        ...
        .where('subcateg',isEqualTo: 'عطور وبرفانات').snapshots();
    return Scaffold(
      backgroundColor: Colors.grey.shade300,
      appBar: AppBar(
        elevation: 0,
        centerTitle: true,
        title: AppBarTitle(title: 'العطور',),
